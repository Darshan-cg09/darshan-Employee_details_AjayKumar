...
app.use(cors({
  origin: [
    'http://51.21.170.10:3000', // Login Server
    'http://51.21.170.10:3001', // Employee Server
    'http://51.21.170.10:5500', // Live Server (Default)
    'http://51.21.170.10:5500', // Live Server (IP)
    'http://51.21.170.10:5501'  // Live Server (Alternate)
  ]
}));
